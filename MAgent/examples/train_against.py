...
if __name__ == "__main__":
    ...
    if args.alg == 'dqn':
        ...
        from models.tf_model import AdvantageActorCritic
        step_batch_size = 10 * args.map_size * args.map_size * 0.04
        models.append(ProcessingModel(env, handles[0], names[0], 20001, 1000, AdvantageActorCritic,
                                             learning_rate=1e-3))
    elif args.alg == 'ppo':
        from models.tf_model import PPO
        step_batch_size = 10 * args.map_size * args.map_size * 0.04
